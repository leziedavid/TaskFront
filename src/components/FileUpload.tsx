...
const FileUpload: React.FC<Props> = ({ titles, setTitles, file, setFile, fileObjects, setFileObjects }) => {
            ...
            {fileObjects.map((fileObject, index) => (
                <div key={index} className="md:flex md:items-center mb-4">
                    ...
                    <div className="md:w-2/12 mt-4 md:mt-8 md:ml-4">
                        <button className="flex justify-center rounded bg-danger py-2 px-3 font-medium text-gray hover:bg-opacity-90" type="button" onClick={() => handleRemove(index)}>
