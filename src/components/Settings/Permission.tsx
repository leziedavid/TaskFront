                                    ...
                                    <table className="shadow-lg min-w-full  border border-gray-900">
                                        ...
                                        <thead className="bg-gray-50 dark:bg-gray-800">
                                            <tr>
                                                ...
                                                <th scope="col" className="px-5 py_5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Permission</th>
                                                <th scope="col" className="px-5 py_5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Acces</th>
