                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-screen-lg w-full p-6 md:p-8">
                        <div className="relative">
                            ...
                            <div className="flex justify-end gap-4.5">
                                <button onClick={onClose} className="flex justify-center rounded-lg bg-[#012340] py-2 px-6 font-medium text-gray hover:bg-opacity-90" type="button" > FERMER </button>
                            </div>
