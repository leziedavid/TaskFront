...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside ref={sidebar} className={`absolute left-0 top-0 z-9999 flex h-screen w-71 flex-col overflow-y-hidden bg-[#03233F] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`} >

      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/auth/dashboard">
          <h1 className="mb-1 ml-4 text-4xl font-semibold text-white"> Tasks </h1>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <h3 className="mb-4 ml-4 text-2xl  font-semibold text-white"> MENU PRINCIPALE  </h3>
            ...
            {/* pathname === '/' ||  */}
              ...
              <li>
                <NavLink to="/auth/dashboard" className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                      (pathname.includes('auth/dashboard')) && 'bg-[#F27F1B] dark:bg-meta-4' }`}>
                      <svg
                          className="fill-current"
                          width="18"
                          height="18"
              ...
              <li>
                <NavLink
                  to="/auth/projets" className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                    pathname.includes('projets') && 'bg-[#F27F1B] dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
