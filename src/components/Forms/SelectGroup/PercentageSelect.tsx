...
interface PercentageSelectProps {
    value: string; // La valeur est maintenant une chaîne représentant l'intervalle, par exemple "0-10"
    onChange: (value: string) => void; // La fonction onChange reçoit également une chaîne
}
