...
import { formatDate, formatDateTime } from '../../services/DateUtils';
...
const TaskDetail: React.FC = () => {
    ...
    return (
        <>
            ...
            <Breadcrumb pageTilte="Tâche" pageElement={response?.tasks[0]?.taskName} pageName="Detail" />
                                ...
                                <div className="p-6 bg-gray-100 border-[#E3E3E3] border rounded-lg dark:bg-gray-800 md:p-8">
                                    ...
                                    <p className="leading-loose text-gray-500 dark:text-gray-300">
                                        ...
                                        <div className="mb-3 text-[20px]">
                                            ...
                                            <input disabled value={response.tasks[0]?.taskName} className="bg-white text-[25px] font-bold w-full rounded-lg border border-stroke py-1 px-2 text-black focus:border-black focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-black" type="text" name="Libelet" placeholder="" />
                                        </div>

                                        <div className=" mb-3 w-full rounded border border-stroke  py-10 pl-11.5 pr-4.5 text-black focus-visible:outline-none dark:border-strokedark  dark:text-white dark:focus:border-black" dangerouslySetInnerHTML={{ __html: response.tasks[0]?.taskDescription }}></div>
                                                ...
                                                response.assignedUsers.map((user, index) => (
                                                    <>
                                                        <div className="flex items-center space-x-2 rounded-lg border border-stroke p-2">
                                                            <img src={UserOne} alt="User" className="w-6 h-6 rounded-lg" />
                                            ...
                                            <div id="default-styled-tab-content">
                                                ...
                                                <div className={`p-4 ${activeTab === 'styled-dashboard' ? 'block' : 'hidden'} rounded-lg bg-gray-50 dark:bg-gray-800`} id="styled-dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                                    ...
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                                        ...
                                                        {response && response.observations.length > 0 ? (
                                                            <Link to={`/auth/Admin/obs/lites/${id}`} type="button" className="flex items-center justify-center w-full text-white bg-[#012340] hover:bg-[#012340] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#012340] dark:hover:bg-[#012340] focus:outline-none dark:focus:ring-[#012340]">
                                                ...
                                                <div className={`p-4 ${activeTab === 'styled-settings' ? 'block' : 'hidden'} rounded-lg bg-gray-50 dark:bg-gray-800`} id="styled-settings" role="tabpanel" aria-labelledby="settings-tab">
                                                    ...
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">
                                                                    ...
                                                                    {response && response.actions.length > 0 ? (
                                                                        response.actions.map((action, index) => (
                                                                            ...
                                                                            <tr key={index} className="cursor-pointer bg-white drop-shadow-sm hover:shadow-lg">
                                                                                <td className="whitespace-nowrap py-3 text-[#000000] px-3 text-[15px] font-normal text-gray-600 ">
                                                        ...
                                                        {response && response.actions.length > 0 ? (
                                                            <Link to={`/auth/Admin/action/lites/${id}`} type="button" className="flex items-center justify-center w-full text-white bg-[#012340] hover:bg-[#012340] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 me-2 mb-2 dark:bg-[#012340] dark:hover:bg-[#012340] focus:outline-none dark:focus:ring-[#012340]">
                                                                <span className="mr-2">VOIR PLUS</span>
