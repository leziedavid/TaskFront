...
import SelectAllFonction from "../components/Forms/SelectGroup/SelectAllFonction";
import SelectDepartment from "../components/Forms/SelectGroup/SelectDepartment";
import { getUserByIdWithDepartments, updateUser } from '../services/UsersService';
import { Department } from '../interfaces/Department';
import SelectAllRoles from "../components/Forms/SelectGroup/SelectAllRoles";
  ...
  return (
    <>
      ...
      <div className="rounded-lg border border-stroke bg-white py-3 shadow-default dark:border-strokedark dark:bg-boxdark flex items-start flex-col sm:flex-row px-4">
        ...
        <div className="flex-1 bg-gray-100  rounded-sm p-4 mx-2 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600">Fonction : {fonctions}  </p>
            <p className="text-lg text-gray-400">Crée le  <DateConverter dateStr={userCreatedAt}/>   </p>
          </div>
        </div>
      ...
      <div className="col-span-12 mb-8">
        <div className="rounded-lg border border-stroke bg-white py-1 shadow-default dark:border-strokedark dark:bg-boxdark flex items-center px-4 space-x-4">
          <div className="flex space-x-6">
            <button className="bg-gray-200 text-gray-700 font-semibold uppercase py-2 px-4 rounded-lg border border-transparent transition-colors duration-300 hover:bg-gray-300 active:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500">
              Mon Profil
            </button>
            <button className="bg-gray-200 text-gray-700 font-semibold uppercase py-2 px-4 rounded-lg border border-transparent transition-colors duration-300 hover:bg-gray-300 active:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500">
      ...
      <div className="col-span-12">
      <div className="rounded-lg border border-stroke bg-white py-3 shadow-default dark:border-strokedark dark:bg-boxdark px-4">
            ...
            <form action="#">
                  ...
                  <div className="relative">
                    <span className="absolute left-4.5 top-4">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 0C9.06087 0 10.0783 0.421427 10.8284 1.17157C11.5786 1.92172 12 2.93913 12 4C12 5.06087 11.5786 6.07828 10.8284 6.82843C10.0783 7.57857 9.06087 8 8 8C6.93913 8 5.92172 7.57857 5.17157 6.82843C4.42143 6.07828 4 5.06087 4 4C4 2.93913 4.42143 1.92172 5.17157 1.17157C5.92172 0.421427 6.93913 0 8 0ZM8 10C12.42 10 16 11.79 16 14V16H0V14C0 11.79 3.58 10 8 10Z" fill="black" fill-opacity="0.6" />
                      </svg>

                    </span>
                    <input value={firstname} onChange={handleFirstnameChange} className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text" placeholder="Saisir le non de l'utilisateur"
                    />
                  </div>
                </div>
                ...
                <div className="w-full sm:w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
              ...
              <div className="mb-5 flex flex-col gap-5.5 sm:flex-row">
                ...
                <div className="w-full sm:w-1/2">
                  ...
                  <div className="relative">
                    <span className="absolute left-4.5 top-4">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM19.6 8.25L12.53 12.67C12.21 12.87 11.79 12.87 11.47 12.67L4.4 8.25C4.29973 8.19371 4.21192 8.11766 4.14189 8.02645C4.07186 7.93525 4.02106 7.83078 3.99258 7.71937C3.96409 7.60796 3.9585 7.49194 3.97616 7.37831C3.99381 7.26468 4.03434 7.15581 4.09528 7.0583C4.15623 6.96079 4.23632 6.87666 4.33073 6.811C4.42513 6.74533 4.53187 6.69951 4.6445 6.6763C4.75712 6.65309 4.87328 6.65297 4.98595 6.67595C5.09863 6.69893 5.20546 6.74453 5.3 6.81L12 11L18.7 6.81C18.7945 6.74453 18.9014 6.69893 19.014 6.67595C19.1267 6.65297 19.2429 6.65309 19.3555 6.6763C19.4681 6.69951 19.5749 6.74533 19.6693 6.811C19.7637 6.87666 19.8438 6.96079 19.9047 7.0583C19.9657 7.15581 20.0062 7.26468 20.0238 7.37831C20.0415 7.49194 20.0359 7.60796 20.0074 7.71937C19.9789 7.83078 19.9281 7.93525 19.8581 8.02645C19.7881 8.11766 19.7003 8.19371 19.6 8.25Z" fill="black" fill-opacity="0.6" />
                      </svg>
                    </span>

                    <input value={email} onChange={(event) => { setEmail(event.target.value); }} className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="email" name="emailAddress" id="emailAddress" placeholder="devidjond45@gmail.com" />
                  </div>
                </div>
                ...
                <div className="w-full sm:w-1/2">
                  <div className="relative">
                    ...
                    <input value={compteName} readOnly className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="email" name="emailAddress" id="emailAddress" placeholder="Nom du compte" />
              ...
              <div className="flex justify-end gap-4.5">
                <button onClick={lastePage}  className="flex justify-center  bg-gray-3 rounded border border-stroke py-2 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white" type="submit" >
                Annuler
                </button>

                <button onClick={update} className="flex justify-center rounded bg-[#012340] py-2 px-6 font-medium text-gray hover:bg-opacity-90" type="button" >
