                ...
                <div className=" mb-10 col-span-5 xl:col-span-3">
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
                            <h3 className="text-title-md2 font-semibold text-black dark:text-white"> Ajouter un  utilisateur {password} </h3>
                        </div>
                                ...
                                <form>
                                    ...
                                    <div className="mb-5 flex flex-col gap-5.5 sm:flex-row">
                                        ...
                                        <div className="relative">
                                                ...
                                                <input value={compteName} readOnly className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="email" placeholder="Nom du compte" />
                                    ...
                                    <div className="mb-5 flex flex-col gap-5.5 sm:flex-row">
                                        ...
                                        <div className="w-full sm:w-1/2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <SelectAllRoles setRole={setRole} rolesValue={''} />
                                            </div>
                                    ...
                                    {Load ? (
                                        ...
                                        <div className="flex justify-end gap-4.5">
                                            ...
                                            <button  onClick={AddData} className="flex justify-center rounded bg-[#012340] py-2 px-6 font-medium text-gray hover:bg-opacity-90" type="button" >
                                                AJOUTER
                                            </button>
