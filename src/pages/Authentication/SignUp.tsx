        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <div className="text-center">
                  <h1 className="mb-4 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">INSCRIPTION</h1>
                </div>
                    ...
                    <form>
                            ...
                            <div className="w-full sm:w-1/2">
                                <div className="relative">
                                    ...
                                    <input  value={firstname} onChange={(event) => { setFirstname(event.target.value); }}
                                        ...
                                        type="text"
                                        placeholder="Saisir le non de l'utilisateur"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="mb-5 flex flex-col gap-5.5 sm:flex-row">
                            ...
                            <div className="w-full sm:w-1/2">
                                <div className="relative">
                                    ...
                                    <input value={phone} onChange={(event) => { setPhone(event.target.value); }}  className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="number" placeholder="+225 0505055005 " defaultValue="+225 0505055005" />
                                </div>
                            </div>
                        ...
                        <div className="mb-5 flex flex-col gap-5.5 sm:flex-row">
                            ...
                            <div className="w-full sm:w-1/2">
                                ...
                                <input value={email} onChange={(event) => { setEmail(event.target.value); }} className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="email" placeholder="devidjond45@gmail.com" />
                            </div>
                            </div>
                            ...
                            <div className="relative">
                                    ...
                                    <input  value={compteName} onChange={(event) => { setCompteName(event.target.value); }} className="w-full rounded border border-stroke bg-white py-3 pl-11.5 pr-4.5 text-black focus:border-gray-700 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" type="email" placeholder="Nom du compte" />
                                  ...
                                  >
                                    {showPassword ? (
                                      <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                                        d="M10 3.33333C5.91667 3.33333 2.5 6.75 2.5 10C2.5 13.25 5.91667 16.6667 10 16.6667C14.0833 16.6667 17.5 13.25 17.5 10C17.5 6.75 14.0833 3.33333 10 3.33333ZM10 14.1667C8.62083 14.1667 7.5 13.0458 7.5 11.6667C7.5 10.2875 8.62083 9.16667 10 9.16667C11.3792 9.16667 12.5 10.2875 12.5 11.6667C12.5 13.0458 11.3792 14.1667 10 14.1667ZM10 5.83333C8.32833 5.83333 6.83333 7.32833 6.83333 8.33333C6.83333 9.33833 8.32833 10.8333 10 10.8333C11.6717 10.8333 13.1667 9.33833 13.1667 8.33333C13.1667 7.32833 11.6717 5.83333 10 5.83333Z"
                                      />
                                    ) : (
                                      <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                                        d="M10 5.83333C8.32833 5.83333 6.83333 7.32833 6.83333 8.33333C6.83333 9.33833 8.32833 10.8333 10 10.8333C11.6717 10.8333 13.1667 9.33833 13.1667 8.33333C13.1667 7.32833 11.6717 5.83333 10 5.83333ZM10 3.33333C5.91667 3.33333 2.5 6.75 2.5 10C2.5 13.25 5.91667 16.6667 10 16.6667C14.0833 16.6667 17.5 13.25 17.5 10C17.5 6.75 14.0833 3.33333 10 3.33333Z"
                                      />
                                    )}
                                  </svg>
                                </span>
                        ...
                        {Load ? (
                          ...
                          <div className="flex gap-4.5">
                            <button onClick={AddData} className="w-full flex justify-center rounded bg-[#012340] py-2 px-6 font-medium text-gray hover:bg-opacity-90" type="button" >
                              S'INSCRIRE
                            </button>
                          </div>
