  ...
  return (
    <>
      ...
      <div ref={selectRef} className="relative z-0 bg-white dark:bg-form-input">
        <div onClick={handleToggleDropdown} className="w-full rounded-lg border border-stroke bg-transparent py-2 px-5 outline-none transition focus:border-[#03233F] active:border-[#03233F] dark:border-form-strokedark cursor-pointer">
          <div className="flex items-center justify-between">
            <span className={`truncate ${selectedOption ? 'text-black dark:text-white' : ''}`}>
              {selectedOption ? selectedOption.departmentName : 'Sélectionnez'}
            </span>
        ...
        {isDropdownOpen && (
          <div className="mt-1 z-10 absolute w-full bg-white dark:bg-form-input shadow-lg rounded border border-stroke">
