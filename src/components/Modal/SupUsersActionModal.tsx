...
const SupUsersActionModal: React.FC<ModalProps> = ({ buttonColor,actionMessage,onDeleteMessage,onCloseMessage, id, onDelete, isOpen, onClose }) => {
    ...
    return (
        <>
            {isOpen && (
                ...
                >
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-4 md:p-5">
                        <div className="relative">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <svg
                                    ...
                                    style={{ stroke: `${buttonColor}`, fill: `${buttonColor}` }}
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 20 20"
                                ...
                                <div className="space-x-4">
                                    <button
                                        ...
                                        data-modal-hide="popup-modal">  {onDeleteMessage}
                                    </button>
...
export default SupUsersActionModal;
