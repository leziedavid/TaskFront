...
import StatisticsDashboard from '../../components/Charts/StatisticsDashboard';
import { getStatistique } from '../../services/getStatistique';
import { GlobalStatsDTO } from '../../interfaces/globalStatsDTO';
...
const Dashboard: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-full p-4 md:p-6 2xl:p-1">
