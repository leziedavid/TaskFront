...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside ref={sidebar} className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#03233F] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <NavLink
                        to="#"  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                          (pathname === '/' || pathname.includes('dashboard')) && 'bg-[#F27F1B] dark:bg-meta-4'
                        }`}
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                    pathname.includes('calendar') &&
                    'bg-[#F27F1B] dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-[#F27F1B] dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-[#F27F1B] dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-[#F27F1B] dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#F27F1B] dark:hover:bg-meta-4 ${
