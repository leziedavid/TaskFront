                                    ...
                                    <div className=" flex flex-col gap-5.5 sm:flex-row">
                                        ...
                                        <div className="w-full sm:w-1/2">
                                            ...
                                            <div className="relative">
                                                <input disabled={isdisabled}  className="w-full rounded border  border-stroke  py-2 pl-11.5 pr-4.5 text-black focus:border-black focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-black" type="datetime-local" placeholder=""   value={dateDebut} onChange={(e) => setDateDebut(e.target.value)}
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-full sm:w-1/2">
                                            ...
                                            <input disabled={isdisabled}  className="w-full rounded border border-stroke  py-2 px-4.5 text-black focus:border-black focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-black"  type="datetime-local" placeholder="" value={dateFin} onChange={(e) => setDateFin(e.target.value)}
                                            />
                                        </div>
                                        ...
                                        <div className="space-x-4 flex items-center justify-end p-5">
                                            {!isdisabled ? (
                                                ...
                                                <button onClick={() => SaveAction()} type="button"
                                                    className="py-2.5 px-5 text-sm font-medium text-gray-900 text-white focus:outline-none bg-[#012340] rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
